...
--
CREATE TRIGGER tablename_audit_proxy_labels
  AFTER INSERT OR DELETE OR UPDATE ON tq_contents.labels FOR EACH ROW
  EXECUTE PROCEDURE audit.if_modified_func();
...
--
CREATE TRIGGER tablename_audit_proxy_details
